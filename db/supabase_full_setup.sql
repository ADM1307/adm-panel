...
-- ===== 18 prospectos reales de Chihuahua (calificados, con oferta) =====
INSERT INTO leads (empresa,giro,ciudad,estado_pipeline,score,hallazgo_clave,tiene_web,vertical_id,oferta)
VALUES
('Montados La Esquina','restaurantes','Chihuahua','calificada',82,'Reservas/pedidos por DM o teléfono; sin agenda en línea (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Punta Rochi','restaurantes','Chihuahua','calificada',79,'Mexicana; sin pedidos/reservas en línea visibles (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Amorevino','restaurantes','Chihuahua','calificada',77,'Italiana; captación solo por redes (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Tacos Roma','restaurantes','Chihuahua','calificada',80,'Fusión; sin menú/agenda en la web (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Little Tony''s Pizza (Riberas)','restaurantes','Chihuahua','calificada',78,'Pizza; pedidos por teléfono/DM (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Los Camarones Hermanos','restaurantes','Chihuahua','calificada',76,'Mariscos; sin reservas en línea (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('La Pérgola','restaurantes','Chihuahua','calificada',75,'Mexicana; presencia web débil (confirmar)',false,(SELECT id FROM verticales WHERE clave='restaurantes'),'{"necesidad":"Sitio Pro con agenda + WhatsApp (reservas/pedidos)","servicio":"Sitio Pro","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Dr. Darío Ortega Aceves','clinicas','Chihuahua','calificada',85,'Agenda vía Doctoralia/teléfono; sin sitio propio con agenda (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dra. Rosa María Méndez Rey','clinicas','Chihuahua','calificada',84,'Ortodoncia; capta por directorio, sin web propia (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dr. José Alan Villalobos Mendoza','clinicas','Chihuahua','calificada',82,'Implantología; sin sitio con agenda 24/7 (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dra. Priscilla Ruvalcaba Cabrera','clinicas','Chihuahua','calificada',83,'Estética dental; depende de directorio (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dr. César Jair Carreño Hernández','clinicas','Chihuahua','calificada',81,'Odontología digital; poca presencia propia (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dra. Mitsi Delgado Osorio','clinicas','Chihuahua','calificada',80,'General/estética; sin agenda 24/7 (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Dr. Néstor Olivas García','clinicas','Chihuahua','calificada',79,'Prostodoncia; capta por teléfono (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('MY DENT Centro Odontológico','clinicas','Chihuahua','calificada',86,'Clínica multi-especialidad; oportunidad de captación (confirmar)',false,(SELECT id FROM verticales WHERE clave='clinicas'),'{"necesidad":"Sitio Pro con agenda online 24/7 + resenas","servicio":"Sitio Pro con agenda","paquete":"Pro / Arranque","rango":"$18k-30k MXN"}'::jsonb),
('Stay Fit Fitness Center','gimnasios','Chihuahua','calificada',78,'Sin landing de inscripción visible (confirmar)',false,(SELECT id FROM verticales WHERE clave='gimnasios'),'{"necesidad":"Landing de inscripcion + campanas locales","servicio":"Sitio Plus/Pro + Arranque","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Climb 3045','gimnasios','Chihuahua','calificada',76,'Escalada/fitness; captación por redes (confirmar)',false,(SELECT id FROM verticales WHERE clave='gimnasios'),'{"necesidad":"Landing de inscripcion + campanas locales","servicio":"Sitio Plus/Pro + Arranque","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb),
('Bita Fitness','gimnasios','Chihuahua','calificada',74,'Tiene sitio; oportunidad de campañas/ads (confirmar)',false,(SELECT id FROM verticales WHERE clave='gimnasios'),'{"necesidad":"Landing de inscripcion + campanas locales","servicio":"Sitio Plus/Pro + Arranque","paquete":"Pro","rango":"$12k-22k MXN"}'::jsonb)
ON CONFLICT DO NOTHING;

INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dr. Darío Ortega',true FROM leads WHERE empresa='Dr. Darío Ortega Aceves' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dra. Rosa M. Méndez',true FROM leads WHERE empresa='Dra. Rosa María Méndez Rey' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dr. J. A. Villalobos',true FROM leads WHERE empresa='Dr. José Alan Villalobos Mendoza' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dra. Priscilla Ruvalcaba',true FROM leads WHERE empresa='Dra. Priscilla Ruvalcaba Cabrera' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dr. César Carreño',true FROM leads WHERE empresa='Dr. César Jair Carreño Hernández' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dra. Mitsi Delgado',true FROM leads WHERE empresa='Dra. Mitsi Delgado Osorio' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Dr. Néstor Olivas',true FROM leads WHERE empresa='Dr. Néstor Olivas García' ON CONFLICT DO NOTHING;
INSERT INTO contactos (lead_id,nombre,es_principal) SELECT id,'Recepción MY DENT',true FROM leads WHERE empresa='MY DENT Centro Odontológico' ON CONFLICT DO NOTHING;
